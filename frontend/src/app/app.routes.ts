...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'my-store', canActivate: [authGuard], loadComponent: () => import('./features/store-mgmt/store-mgmt.component').then(m => m.StoreMgmtComponent) },
      { path: 'my-services', canActivate: [authGuard], loadComponent: () => import('./features/services-mgmt/services-mgmt.component').then(m => m.ServicesMgmtComponent) },
      { path: 'my-services/:id', canActivate: [authGuard], loadComponent: () => import('./features/services-mgmt/services-mgmt.component').then(m => m.ServicesMgmtComponent) },
      { path: 'my-agenda', canActivate: [authGuard], loadComponent: () => import('./features/agenda-pro/agenda-pro.component').then(m => m.AgendaProComponent) },
